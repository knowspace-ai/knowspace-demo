...
client_id = os.getenv("Quix__Deployment__Name", str(uuid.uuid4()))
...
output_topic = app.topic(output_topic_name, value_deserializer='json')
...
def on_message(client, userdata, msg):
    ...
    message = output_topic.serialize(key=payload["gateway"] + "-" + payload["beacon"],
                                    value=payload)

    # generate sample data
    # if message.key == '582b0aa9025d-ea5d53e0907a':  # wristwatch in office
    # if message.key.endswith('-ea5d53e0907a'):         # wristwatch
